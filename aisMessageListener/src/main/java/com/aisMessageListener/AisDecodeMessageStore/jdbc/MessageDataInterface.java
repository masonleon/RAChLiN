...
public interface MessageDataInterface {
    ...
    /**
     * Processes a message. If it's supported, we write it to tables beyond the overarching MessageData table, e.g. the
     * GeoPositional Data table. Unsupported messages are just dumped to the table, so that they can be retroactively
     * conformed as standards change.
     */
    void processMessage();
